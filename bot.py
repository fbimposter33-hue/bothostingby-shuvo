...
OWNER_ID = int(os.environ.get("OWNER_ID", "7804028677"))
ADMIN_ID = int(os.environ.get("ADMIN_ID", "7804028677"))
YOUR_USERNAME = os.environ.get("YOUR_USERNAME", "@ZEROX_0x1")
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "https://t.me/CodeNestup")
